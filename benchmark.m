...
Params.B = 4.5;   % disutility from working
...
% tax and transfer
Params.tau = 0;  % income tax rate for UBI
Params.Tr = 0;   % initial guess for UBI transfer (is determined in GE)
% prices
...
FnsToEvaluate.L = @(h,aprime,a,z) z*h;
% Taxes
%FnsToEvaluate.taxrevenue = @(h,aprime,a,z,w,tau) tau*w*z*h;
% Transfers
%FnsToEvaluate.transfer = @(h,aprime,a,z,Tr) Tr;
...
% Update the values of r, w, and Tr
Params.r = p_eqm.r;
Params.w = p_eqm.w;
...
fprintf('Output            : %f \n',agg.YY)
fprintf('Capital           : %f \n',agg.KK)
fprintf('Hours worked      : %f \n',agg.HH)
fprintf('Effective labor   : %f \n',agg.LL)
fprintf('Wage rate         : %f \n',Params.w)
fprintf('Interest rate     : %f \n',Params.r)
%fprintf('Income            : %f \n',agg.ZZ)
fprintf('Mean(y_bar)       : %f \n',AllStats.income.Mean)
fprintf('Median            : %f \n',AllStats.income.Median)
fprintf('Before-tax Gini   : %f \n',gini.income)
fprintf('After-tax Gini    : %f \n',gini.netincome)
fprintf('Wealth Gini       : %f \n',gini.wealth)
fprintf('Tax/GDP           : %f \n',agg.TT/agg.YY)
